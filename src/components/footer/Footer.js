...
function Footer() {
  ...
  <div className={styles.footerContent}>
    <div className={styles.contactInfo}>
      ...
      <p>Phone: <a href="tel:+919642675929">+91 9642675929</a></p>
    ...
    <div className={styles.newsletterSection}>
      <h2>Newsletter</h2>
      <p>Ve-Minds is the Knowledge Hub for Future.</p>
  ...
  <div className={styles.footerBottom}>
    <p>&copy; {new Date().getFullYear()} Ve-Minds. All Rights Reserved.</p>
  </div>
</div>
