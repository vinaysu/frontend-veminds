...
function Home() {
  ...
  const companies = [
    ...
    { id: 37, name: 'Company 13', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6Vm3XGxKJanX1dJlkmK7GrvXF8jSzKIT9aw&s' },
    { id: 38, name: 'Company 14', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzz7F8x216ri4_2EIngtokrkfWmWkZKbP5-Q&s' },
    { id: 39, name: 'Company 15', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDIaSagB6KK4JQxSpiqbSXamD72b2MYfHu7Q&s' },
    { id: 40, name: 'Company 16', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR01cfnWI5ri4CFIT3e9ynVsHBCa2CYDSAE7w&s' },
    { id: 41, name: 'Company 7', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTRl_CWF2MJ4-OGEr4PEVGic6jhdR9lYgvLg&s' },
    { id: 42, name: 'Company 8', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTw9A_7Wlof1U7f0BGHA29BXoRH7p-81QA7-w&s' },
    { id: 43, name: 'Company 9', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxRz4SN8U9SKL5k-5-ZdLF7s9GnhjyfrSKWw&s' },
    { id: 44, name: 'Company 10', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIE3c_GQUTimxg6Lz26ls_IgDZdc0sZE2GSQ&s' },
    { id: 45, name: 'Company 11', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_sLodc8l_ohsZZ8d2cUcDS53T8M6khUjsJw&s' },
    { id: 46, name: 'Company 12', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVyNAycmKLcE83NIMU1YSvqyCz7ijofzih3g&s' },
    { id: 47, name: 'Company 13', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXTFyI9fcRFVruyBhlCTX9jShua5fad8S3Nw&s' },
    { id: 48, name: 'Company 14', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtA1hsef6y_Z4ZE3FxUj9wWf9kf_fPefKdUw&s' },
    { id: 49, name: 'Company 15', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZHkYMa-xJJgjebM2oY5K7QWAQSx2TobxP0g&s' },
    { id: 50, name: 'Company 16', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT77aeQQFIizCAVLlvobns6gB43gl4-ddxXZA&s' },
    { id: 51, name: 'Company 7', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgaUBGcI6ofz-qgdC2wFHuhRqT8EG0FiyV8A&s' },
    { id: 52, name: 'Company 8', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ87O97mqVjZjYDfWGeblxY_Cj0fMwshkDc0Q&s' },
    { id: 53, name: 'Company 9', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQleSroI73pOoBR-OGcvaBjQrZLCd0Lug3WsQ&s' },
    { id: 54, name: 'Company 10', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ61mmwPn29TlIDXmO8RoQOpHnk29_3upVKiQ&s' },
    { id: 55, name: 'Company 11', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXeF6o_HoJb_k6v7gAXAM24thLd6436v7cdQ&s' },
    { id: 56, name: 'Company 15', img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjvBfnKgk_7nu9-05R98s3hUqcgqaWBjNHww&s' },
    ...
    <div className={`${styles.home}`}>
      ...
      <div className={styles.companiesContainer}>
        ...
        <div className={`${styles.companiesRow} ${styles.scrollRightToLeft}`}>
          {companies.slice(14, 28).map((company) => (
            <div key={company.id} className={styles.companyCard}>
              <img src={company.img} alt={company.name} className={styles.companyLogo} />
            </div>
          ))}
        ...
        {/* Row 1 - Scroll Left to Right */}
        <div className={`${styles.companiesRow} ${styles.scrollLeftToRight}`}>
          {companies.slice(28, 42).map((company) => (
            <div key={company.id} className={styles.companyCard}>
              <img src={company.img} alt={company.name} className={styles.companyLogo} />
            </div>
          ))}
        ...
        {/* Row 2 - Scroll Right to Left */}
        <div className={`${styles.companiesRow} ${styles.scrollRightToLeft}`}>
          {companies.slice(42, 56).map((company) => (
            <div key={company.id} className={styles.companyCard}>
              <img src={company.img} alt={company.name} className={styles.companyLogo} />
            </div>
          ))}
